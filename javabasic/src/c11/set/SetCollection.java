...
public class SetCollection {
	...
	public static void main(String[] args) {
		...
		//Set<E> - 타입 파라미터 E에는 컬렉션에 저장할 객체 타입을 지정하면
		//됩니다.
		//String 객체를 저장
		...
		//HashSet은 객체를 저장하기 전에 먼저 객체의 hashCode()메소드를
		//호출해서 해시코드를 얻어 내고, 이미 저장되어 있는 객체들의 해시코드와
		//비교합니다. 만약 동일한 해시코드가 있다면 다시 equals()메소드로
		//두 객체를 비교해서 true가 나오면 동일한 객체로 판단하고 중복 저장하지
		//않습니다.
		
		//문자열을 HashSet에 저장할 경우에 같은 문자열을 갖는 String객체는
		//동등한 객체로 간주되고 다른 문자열을 갖는 String 객체는 다른 객체로
		//간주되는데, 그 이유는 String클래스가 hashCode()와 equals()메소드를
		//재정의해서 같은 문자열일 경우 hashCode()의 리턴값은 같게,
		//equals()의 리턴값은 true가 나오도록 했기 때문입니다.
	}
